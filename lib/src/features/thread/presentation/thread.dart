        ...
        Row(
          ...
          children: [
            Row(
              spacing: 8,
              children: [
                GestureDetector(child: Icon(LucideIcons.arrowLeft, size: 42)),
                Column(
                  spacing: 8,
            ...
            GestureDetector(child: Icon(LucideIcons.moreVertical, size: 35)),
          ],
        ),
        SizedBox(height: 8),
        Expanded(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              child: Icon(LucideIcons.bookmark, size: 24),
                            ),
                          ],
                        ),
                      ],
